<?php /* Smarty version 2.6.29, created on 2017-08-17 18:33:57
         compiled from cache/themes/SuiteP/modules/AOS_Quotes/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/themes/SuiteP/modules/AOS_Quotes/EditView.tpl', 47, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/AOS_Quotes/EditView.tpl', 101, false),array('modifier', 'lookup', 'cache/themes/SuiteP/modules/AOS_Quotes/EditView.tpl', 168, false),array('modifier', 'count', 'cache/themes/SuiteP/modules/AOS_Quotes/EditView.tpl', 270, false),array('modifier', 'default', 'cache/themes/SuiteP/modules/AOS_Quotes/EditView.tpl', 542, false),array('function', 'sugar_include', 'cache/themes/SuiteP/modules/AOS_Quotes/EditView.tpl', 63, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/AOS_Quotes/EditView.tpl', 84, false),array('function', 'counter', 'cache/themes/SuiteP/modules/AOS_Quotes/EditView.tpl', 107, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/AOS_Quotes/EditView.tpl', 143, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/AOS_Quotes/EditView.tpl', 171, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/AOS_Quotes/EditView.tpl', 531, false),array('function', 'sugar_getjspath', 'cache/themes/SuiteP/modules/AOS_Quotes/EditView.tpl', 1544, false),array('function', 'sugar_number_format', 'cache/themes/SuiteP/modules/AOS_Quotes/EditView.tpl', 1797, false),)), $this); ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_OPPORTUNITY_OR_PROJECT','module' => 'AOS_Quotes'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<select name="<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['opportunity_or_project']['value'] ) && $this->_tpl_vars['fields']['opportunity_or_project']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['opportunity_or_project']['options'],'selected' => $this->_tpl_vars['fields']['opportunity_or_project']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['opportunity_or_project']['options'],'selected' => $this->_tpl_vars['fields']['opportunity_or_project']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['opportunity_or_project']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['opportunity_or_project']['value']; ?>
...
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['opportunity_or_project']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['name']; ?>
-input"
size="30"
...
id="btn-clear-<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['name']; ?>
...
<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['name']; ?>
<?php echo '");
...
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['name']; ?>
');
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROJECT_NAME','module' => 'AOS_Quotes'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['relate_project_name']['name']; ?>
" class="sqsEnabled" tabindex="" id="<?php echo $this->_tpl_vars['fields']['relate_project_name']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['relate_project_name']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['relate_project_name']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['relate_project_name']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['relate_project_id']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['relate_project_name']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['relate_project_name']['name']; ?>
" tabindex="" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['relate_project_name']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"relate_project_id","name":"relate_project_name"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['relate_project_name']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['relate_project_name']['name']; ?>
" tabindex="" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['relate_project_name']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['relate_project_name']['id_name']; ?>
');"  value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_LABEL'), $this);?>
" ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
...
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['<?php echo $this->_tpl_vars['form_name']; ?>
_<?php echo $this->_tpl_vars['fields']['relate_project_name']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
" class="sqsEnabled" tabindex="" id="<?php echo $this->_tpl_vars['fields']['billing_account']['name']; ?>
...
" class="sqsEnabled" tabindex="" id="<?php echo $this->_tpl_vars['fields']['billing_contact']['name']; ?>
...
<td width="*">
<textarea id="billing_address_street" name="billing_address_street" maxlength="150" rows="2" cols="30" tabindex=""><?php echo $this->_tpl_vars['fields']['billing_address_street']['value']; ?>
</textarea>
</td>
</tr>
<tr>
...
<td width="*">
<textarea id="shipping_address_street" name="shipping_address_street" maxlength="150" rows="2" cols="30" tabindex=""><?php echo $this->_tpl_vars['fields']['shipping_address_street']['value']; ?>
</textarea>
</td>
</tr>
<tr>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_ADDRESS_POSTALCODE','module' => 'AOS_Quotes'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PST_TAX_AMOUNT','module' => 'AOS_Quotes'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<?php if (strlen ( $this->_tpl_vars['fields']['pst_tax_amount']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['pst_tax_amount']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['pst_tax_amount']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['pst_tax_amount']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['pst_tax_amount']['name']; ?>
' size='30' maxlength='26,6' value='<?php echo smarty_function_sugar_number_format(array('var' => $this->_tpl_vars['value']), $this);?>
' title='' tabindex=''
>
</div>
...
<?php echo '\' );
addToValidate(\'EditView\', \'pst_tax_amount\', \'currency\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PST_TAX_AMOUNT','module' => 'AOS_Quotes','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'relate_project_id\', \'id\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROJECT_ID','module' => 'AOS_Quotes','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'relate_project_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROJECT_NAME','module' => 'AOS_Quotes','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'opportunity_or_project\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_OPPORTUNITY_OR_PROJECT','module' => 'AOS_Quotes','for_js' => true), $this);?>
<?php echo '\' );
...
addToValidateBinaryDependency(\'EditView\', \'relate_project_name\', \'alpha\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'AOS_Quotes','for_js' => true), $this);?>
<?php echo ': '; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROJECT_NAME','module' => 'AOS_Quotes','for_js' => true), $this);?>
<?php echo '\', \'relate_project_id\' );
