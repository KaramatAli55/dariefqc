...
<script type="text/javascript" src='cache/include/externalAPI.cache.js?v=4klK0o_m0kKwMH64N01jUA'></script>
...
_remoteSelectBtn" tabindex="" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_SELECT_FILE_TITLE'), $this);?>
...
_remoteClearBtn" tabindex="" title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
...
<input name="revision" type="text" value="<?php echo $this->_tpl_vars['fields']['revision']['value']; ?>
...
<input name="related_document_name" type="text" size="30" maxlength="255" value="<?php echo $this->_tpl_vars['RELATED_DOCUMENT_NAME']; ?>
" readonly><input name="related_doc_id" type="hidden" value="<?php echo $this->_tpl_vars['fields']['related_doc_id']['value']; ?>
...
<select name="related_doc_rev_id" id="related_doc_rev_id" <?php echo $this->_tpl_vars['RELATED_DOCUMENT_REVISION_DISABLED']; ?>
...
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROJECT_NAME','module' => 'Documents','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'related_project_id\', \'id\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROJECT_ID','module' => 'Documents','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'related_projecttask_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROJECTTASK_NAME','module' => 'Documents','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'related_projecttask_id\', \'id\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROJECTTASK_ID','module' => 'Documents','for_js' => true), $this);?>
<?php echo '\' );
