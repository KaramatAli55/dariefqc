...
{if !$fields.related_project_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.related_project_id.value)}
{capture assign="detail_url"}index.php?module=Project&action=DetailView&record={$fields.related_project_id.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="related_project_id" class="sugar_field" data-id-value="{$fields.related_project_id.value}">{$fields.related_project_name.value}</span>
{if !empty($fields.related_project_id.value)}</a>{/if}
{/if}
...
{if !$fields.purchase_order_number.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.purchase_order_number.name}">{$fields.purchase_order_number.value}</span>
{/if}
