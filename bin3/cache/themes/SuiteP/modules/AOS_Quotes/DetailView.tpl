...
<li><input type="button" class="button" onClick="showPopup('email');" value="{$MOD.LBL_EMAIL_QUOTE}"/></li>
...
{if !$fields.opportunity_or_project.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.opportunity_or_project.options)}
<input type="hidden" class="sugar_field" id="{$fields.opportunity_or_project.name}" value="{ $fields.opportunity_or_project.options }">
{ $fields.opportunity_or_project.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.opportunity_or_project.name}" value="{ $fields.opportunity_or_project.value }">
{ $fields.opportunity_or_project.options[$fields.opportunity_or_project.value]}
{/if}
{/if}
...
{if !$fields.relate_project_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.relate_project_id.value)}
{capture assign="detail_url"}index.php?module=Project&action=DetailView&record={$fields.relate_project_id.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="relate_project_id" class="sugar_field" data-id-value="{$fields.relate_project_id.value}">{$fields.relate_project_name.value}</span>
{if !empty($fields.relate_project_id.value)}</a>{/if}
{/if}
...
{if !$fields.pst_tax_amount.hidden}
{counter name="panelFieldCount" print=false}

<span id='{$fields.pst_tax_amount.name}'>
{sugar_number_format var=$fields.pst_tax_amount.value }
</span>
{/if}
