...
<input type="text" name="{$fields.project_parent_name.name}" class="sqsEnabled" tabindex="" id="{$fields.project_parent_name.name}" size="" value="{$fields.project_parent_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.project_parent_name.id_name}" 
id="{$fields.project_parent_name.id_name}" 
value="{$fields.project_parent_id.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.project_parent_name.name}" id="btn_{$fields.project_parent_name.name}" tabindex="" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.project_parent_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"project_parent_id","name":"project_parent_name"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.project_parent_name.name}" id="btn_clr_{$fields.project_parent_name.name}" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.project_parent_name.name}', '{$fields.project_parent_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.project_parent_name.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
<input type="text" name="{$fields.relate_account_name.name}" class="sqsEnabled" tabindex="" id="{$fields.relate_account_name.name}" size="" value="{$fields.relate_account_name.value}" title='' autocomplete="off"  	 >
...
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.relate_account_name.name}" id="btn_{$fields.relate_account_name.name}" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_SELECT_ACCOUNTS_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_ACCESSKEY_SELECT_ACCOUNTS_LABEL"}"
onclick='open_popup(
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"relate_account_id","name":"relate_account_name"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.relate_account_name.name}" id="btn_clr_{$fields.relate_account_name.name}" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE"}"  class="button lastChild"
...
<input class="date_input" autocomplete="off" type="text" name="{$fields.estimated_start_date.name}" id="{$fields.estimated_start_date.name}" value="{$date_value}" title=''  tabindex=''    size="11" maxlength="10" >
...
<input class="date_input" autocomplete="off" type="text" name="{$fields.estimated_end_date.name}" id="{$fields.estimated_end_date.name}" value="{$date_value}" title=''  tabindex=''    size="11" maxlength="10" >
...
{if empty($fields.scope_of_work_c.value)}
{assign var="value" value=$fields.scope_of_work_c.default_value }
{else}
{assign var="value" value=$fields.scope_of_work_c.value }
{/if}
<textarea  id='{$fields.scope_of_work_c.name}' name='{$fields.scope_of_work_c.name}'
rows="8"
cols="80"
title='' tabindex="" 
 >{$value}</textarea>
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.requires_permit.name}" 
id="{$fields.requires_permit.name}" 
title=''       
>
{if isset($fields.requires_permit.value) && $fields.requires_permit.value != ''}
{html_options options=$fields.requires_permit.options selected=$fields.requires_permit.value}
{else}
{html_options options=$fields.requires_permit.options selected=$fields.requires_permit.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.requires_permit.options }
{capture name="field_val"}{$fields.requires_permit.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.requires_permit.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.requires_permit.name}" 
id="{$fields.requires_permit.name}" 
title=''          
>
{if isset($fields.requires_permit.value) && $fields.requires_permit.value != ''}
...
<input
id="{$fields.requires_permit.name}-input"
name="{$fields.requires_permit.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.requires_permit.name}-image"></button><button type="button"
id="btn-clear-{$fields.requires_permit.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.requires_permit.name}-input', '{$fields.requires_permit.name}');sync_{$fields.requires_permit.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.requires_permit.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.requires_permit.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.requires_permit.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.requires_permit.name}');
			...
			//global variable 
			sync_{/literal}{$fields.requires_permit.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.requires_permit.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.requires_permit.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{/if}  
<input type='text' name='{$fields.permit_value.name}' 
id='{$fields.permit_value.name}' size='30' 
maxlength='50' 
value='{$value}' title=''      >
</div>
...
addToValidate('EditView', 'description', 'text', true,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='Project' for_js=true}{literal}' );
...
addToValidate('EditView', 'estimated_end_date', 'date', false,'{/literal}{sugar_translate label='LBL_DATE_END' module='Project' for_js=true}{literal}' );
...
addToValidate('EditView', 'jjwg_maps_address_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_JJWG_MAPS_ADDRESS' module='Project' for_js=true}{literal}' );
addToValidate('EditView', 'scope_of_work_c', 'text', false,'{/literal}{sugar_translate label='LBL_SCOPE_OF_WORK' module='Project' for_js=true}{literal}' );
addToValidate('EditView', 'requires_permit', 'enum', false,'{/literal}{sugar_translate label='LBL_REQUIRES_PERMIT' module='Project' for_js=true}{literal}' );
addToValidate('EditView', 'permit_value', 'varchar', false,'{/literal}{sugar_translate label='LBL_PERMIT_VALUE' module='Project' for_js=true}{literal}' );
addToValidate('EditView', 'relate_account_id', 'id', false,'{/literal}{sugar_translate label='LBL_ACCOUNTS_ID' module='Project' for_js=true}{literal}' );
addToValidate('EditView', 'relate_account_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ACCOUNT_NAME_SINGULAR' module='Project' for_js=true}{literal}' );
addToValidate('EditView', 'project_parent_id', 'id', false,'{/literal}{sugar_translate label='LBL_SUB_PROJECTS' module='Project' for_js=true}{literal}' );
addToValidate('EditView', 'project_parent_name', 'relate', false,'{/literal}{sugar_translate label='LBL_SUB_PROJECTS' module='Project' for_js=true}{literal}' );
addToValidate('EditView', 'type_c', 'enum', true,'{/literal}{sugar_translate label='LBL_TYPE' module='Project' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'relate_account_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Project' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ACCOUNT_NAME_SINGULAR' module='Project' for_js=true}{literal}', 'relate_account_id' );
addToValidateBinaryDependency('EditView', 'project_parent_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Project' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_SUB_PROJECTS' module='Project' for_js=true}{literal}', 'project_parent_id' );
