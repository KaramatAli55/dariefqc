...
<button type="button" name="{$fields.filename.name}_remoteSelectBtn" id="{$fields.filename.name}_remoteSelectBtn" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_SELECT_FILE_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_ACCESSKEY_SELECT_FILE_LABEL"}"
...
<button type="button" name="{$fields.filename.name}_remoteClearBtn" id="{$fields.filename.name}_remoteClearBtn" tabindex="" title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" value="{$APP.LBL_CLEAR_BUTTON_LABEL}" onclick="SUGAR.field.file.clearRemote('{$fields.filename.name}'); return false;">
...
{counter name="panelFieldCount"  print=false}
<input name="revision" type="text" value="{$fields.revision.value}" {$DISABLED}>
</div>
...
<input class="date_input" autocomplete="off" type="text" name="{$fields.active_date.name}" id="{$fields.active_date.name}" value="{$date_value}" title=''  tabindex=''    size="11" maxlength="10" >
...
<input class="date_input" autocomplete="off" type="text" name="{$fields.exp_date.name}" id="{$fields.exp_date.name}" value="{$date_value}" title=''  tabindex=''    size="11" maxlength="10" >
...
{counter name="panelFieldCount"  print=false}
<select name="related_doc_rev_id" id="related_doc_rev_id" {$RELATED_DOCUMENT_REVISION_DISABLED}>{$RELATED_DOCUMENT_REVISION_OPTIONS}</select>
</div>
...
addToValidate('EditView', 'related_project_name', 'relate', false,'{/literal}{sugar_translate label='LBL_PROJECT_NAME' module='Documents' for_js=true}{literal}' );
addToValidate('EditView', 'related_project_id', 'id', false,'{/literal}{sugar_translate label='LBL_PROJECT_ID' module='Documents' for_js=true}{literal}' );
addToValidate('EditView', 'related_projecttask_name', 'relate', false,'{/literal}{sugar_translate label='LBL_PROJECTTASK_NAME' module='Documents' for_js=true}{literal}' );
addToValidate('EditView', 'related_projecttask_id', 'id', false,'{/literal}{sugar_translate label='LBL_PROJECTTASK_ID' module='Documents' for_js=true}{literal}' );
