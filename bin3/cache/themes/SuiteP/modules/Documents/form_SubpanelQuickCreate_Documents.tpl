...
addToValidate('form_SubpanelQuickCreate_Documents', 'related_project_name', 'relate', false,'{/literal}{sugar_translate label='LBL_PROJECT_NAME' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'related_project_id', 'id', false,'{/literal}{sugar_translate label='LBL_PROJECT_ID' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'related_projecttask_name', 'relate', false,'{/literal}{sugar_translate label='LBL_PROJECTTASK_NAME' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'related_projecttask_id', 'id', false,'{/literal}{sugar_translate label='LBL_PROJECTTASK_ID' module='Documents' for_js=true}{literal}' );
