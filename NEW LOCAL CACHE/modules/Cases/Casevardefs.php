 ...
 $GLOBALS["dictionary"]["Case"]=array (
  ...
  array (
    ...
    array (
      ...
      'inline_edit' => true,
      'comments' => 'Describe detailed instructions for tech who will be performing work',
      'merge_filter' => 'disabled',
      'rows' => '10',
      'cols' => '80',
    ),
    ...
    array (
      ...
      'default' => '0.0',
      'no_default' => false,
      'comments' => 'Type in qty of hours in 0.5 increments',
      'help' => '',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
    ...
    array (
      ...
      'no_default' => false,
      'comments' => '',
      'help' => 'Enter date the case was completed',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      'audited' => false,
      ...
      'size' => '20',
      'enable_range_search' => false,
      'id' => 'Casescompleted_date_c',
      'custom_module' => 'Cases',
    ),
    'case_location_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Service Location:',
      'required' => true,
      'source' => 'custom_fields',
      'name' => 'case_location_c',
      'vname' => 'LBL_CASE_LOCATION',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => 'Pacificom_Offices',
      'no_default' => false,
      'comments' => '',
      'help' => '',
      'importable' => 'true',
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'case_location',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Casescase_location_c',
      'custom_module' => 'Cases',
    ),
    'case_materials_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Materials:',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'case_materials_c',
      'vname' => 'LBL_CASE_MATERIALS',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      'comments' => '',
      'help' => 'List all materials used',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      'audited' => false,
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Casesreferencenum_c',
      'custom_module' => 'Cases',
    ),
    'site_contact_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Site Contact:',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'site_contact_c',
      'vname' => 'LBL_SITE_CONTACT',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
