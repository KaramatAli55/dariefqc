...
id='{$fields.total_contract_value.name}' size='30' maxlength='26,6' value='{sugar_number_format var=$value}' title='' tabindex=''
>
</div>
...
<input type="text" name="{$fields.contact.name}" class="sqsEnabled" tabindex="" id="{$fields.contact.name}" size="" value="{$fields.contact.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.contact.id_name}" 
id="{$fields.contact.id_name}" 
value="{$fields.contact_id.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.contact.name}" id="btn_{$fields.contact.name}" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_SELECT_CONTACTS_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_ACCESSKEY_SELECT_CONTACTS_LABEL"}"
onclick='open_popup(
...
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.contact.name}" id="btn_clr_{$fields.contact.name}" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_CONTACTS_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.contact.name}', '{$fields.contact.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_CONTACTS_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="datetimecombo" field="renewal_reminder_date" colspan='3' >
{counter name="panelFieldCount" print=false}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PROJECT_NAME' module='AOS_Contracts'}{/capture}
{$label|strip_semicolon}:

</div>

<div class="col-xs-12 col-sm-8 edit-view-field " type="relate" field="related_project_name"  >
{counter name="panelFieldCount" print=false}

<input type="text" name="{$fields.related_project_name.name}" class="sqsEnabled" tabindex="" id="{$fields.related_project_name.name}" size="" value="{$fields.related_project_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.related_project_name.id_name}" 
id="{$fields.related_project_name.id_name}" 
value="{$fields.related_project_id.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.related_project_name.name}" id="btn_{$fields.related_project_name.name}" tabindex="" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.related_project_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"related_project_id","name":"related_project_name"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.related_project_name.name}" id="btn_clr_{$fields.related_project_name.name}" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.related_project_name.name}', '{$fields.related_project_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.related_project_name.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
<a class="" role="button" data-toggle="collapse" aria-expanded="false">
<div class="col-xs-10 col-sm-11 col-md-11">
{sugar_translate label='LBL_EDITVIEW_PANEL1' module='AOS_Contracts'}
</div>
</a>
</div>
...
id='{$fields.discount_amount.name}' size='30' maxlength='26,6' value='{sugar_number_format var=$value}' title='' tabindex=''
>
</div>
...
addToValidate('EditView', 'call_id', 'id', false,'{/literal}{sugar_translate label='' module='AOS_Contracts' for_js=true}{literal}' );
...
addToValidate('EditView', 'file_mime_type', 'varchar', false,'{/literal}{sugar_translate label='LBL_FILE_MIME_TYPE' module='AOS_Contracts' for_js=true}{literal}' );
addToValidate('EditView', 'file_url', 'function', false,'{/literal}{sugar_translate label='LBL_FILE_URL' module='AOS_Contracts' for_js=true}{literal}' );
addToValidate('EditView', 'filename', 'file', false,'{/literal}{sugar_translate label='LBL_FILENAME' module='AOS_Contracts' for_js=true}{literal}' );
addToValidate('EditView', 'related_project_name', 'relate', false,'{/literal}{sugar_translate label='LBL_PROJECT_NAME' module='AOS_Contracts' for_js=true}{literal}' );
addToValidate('EditView', 'related_project_id', 'id', false,'{/literal}{sugar_translate label='LBL_PROJECT_ID' module='AOS_Contracts' for_js=true}{literal}' );
addToValidate('EditView', 'purchase_order_number', 'varchar', false,'{/literal}{sugar_translate label='LBL_PURCHASE_ORDER_NUMBER' module='AOS_Contracts' for_js=true}{literal}' );
