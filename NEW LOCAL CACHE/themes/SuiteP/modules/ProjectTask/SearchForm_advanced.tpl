...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'>{sugar_translate label='LBL_NAME' module='ProjectTask'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    value='{$value}' title=''      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='project_name_advanced'>{sugar_translate label='LBL_PROJECT_NAME' module='ProjectTask'}</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="{$fields.project_name_advanced.name}"  class="sqsEnabled"   id="{$fields.project_name_advanced.name}" size="" value="{$fields.project_name_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.project_id_advanced.name}" value="{$fields.project_id_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.project_name_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.project_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"project_id_advanced","name":"project_name_advanced"}}{/literal}, "single", true);'>{sugar_getimage alt=$app_strings.LBL_ID_FF_SELECT name="id-ff-select" ext=".png" other_attributes=''}</button><button type="button" name="btn_clr_{$fields.project_name_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.project_name_advanced.name}.value = ''; this.form.{$fields.project_id_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
</span>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='ProjectTask'}</label>
                            </div>
            <div class="form-item">
