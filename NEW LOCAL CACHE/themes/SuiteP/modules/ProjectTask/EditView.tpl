...
{capture name="label" assign="label"}{sugar_translate label='LBL_PROJECT_TASK_ID' module='ProjectTask'}{/capture}
{$label|strip_semicolon}:
...
<input type="text" name="{$fields.projecttask_parent_name.name}" class="sqsEnabled" tabindex="" id="{$fields.projecttask_parent_name.name}" size="" value="{$fields.projecttask_parent_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.projecttask_parent_name.id_name}" 
id="{$fields.projecttask_parent_name.id_name}" 
value="{$fields.projecttask_parent_id.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.projecttask_parent_name.name}" id="btn_{$fields.projecttask_parent_name.name}" tabindex="" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.projecttask_parent_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"projecttask_parent_id","name":"projecttask_parent_name"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.projecttask_parent_name.name}" id="btn_clr_{$fields.projecttask_parent_name.name}" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.projecttask_parent_name.name}', '{$fields.projecttask_parent_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.projecttask_parent_name.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
addToValidate('EditView', 'file_mime_type', 'varchar', false,'{/literal}{sugar_translate label='LBL_FILE_MIME_TYPE' module='ProjectTask' for_js=true}{literal}' );
addToValidate('EditView', 'file_url', 'function', false,'{/literal}{sugar_translate label='LBL_FILE_URL' module='ProjectTask' for_js=true}{literal}' );
addToValidate('EditView', 'filename', 'file', false,'{/literal}{sugar_translate label='LBL_FILENAME' module='ProjectTask' for_js=true}{literal}' );
addToValidate('EditView', 'projecttask_parent_name', 'relate', false,'{/literal}{sugar_translate label='LBL_SUB_PROJECTTASK_NAME' module='ProjectTask' for_js=true}{literal}' );
addToValidate('EditView', 'projecttask_parent_id', 'id', false,'{/literal}{sugar_translate label='LBL_SUB_PROJECTTASKS_ID' module='ProjectTask' for_js=true}{literal}' );
