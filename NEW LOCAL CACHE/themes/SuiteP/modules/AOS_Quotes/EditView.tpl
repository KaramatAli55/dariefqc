...
{capture name="label" assign="label"}{sugar_translate label='LBL_OPPORTUNITY_OR_PROJECT' module='AOS_Quotes'}{/capture}
{$label|strip_semicolon}:

</div>

<div class="col-xs-12 col-sm-8 edit-view-field " type="enum" field="opportunity_or_project"  >
{counter name="panelFieldCount" print=false}

{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.opportunity_or_project.name}" 
id="{$fields.opportunity_or_project.name}" 
title=''       
>
{if isset($fields.opportunity_or_project.value) && $fields.opportunity_or_project.value != ''}
{html_options options=$fields.opportunity_or_project.options selected=$fields.opportunity_or_project.value}
{else}
{html_options options=$fields.opportunity_or_project.options selected=$fields.opportunity_or_project.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.opportunity_or_project.options }
{capture name="field_val"}{$fields.opportunity_or_project.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.opportunity_or_project.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.opportunity_or_project.name}" 
id="{$fields.opportunity_or_project.name}" 
title=''          
>
{if isset($fields.opportunity_or_project.value) && $fields.opportunity_or_project.value != ''}
...
<input
id="{$fields.opportunity_or_project.name}-input"
name="{$fields.opportunity_or_project.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.opportunity_or_project.name}-image"></button><button type="button"
id="btn-clear-{$fields.opportunity_or_project.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.opportunity_or_project.name}-input', '{$fields.opportunity_or_project.name}');sync_{$fields.opportunity_or_project.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
	...
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.opportunity_or_project.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.opportunity_or_project.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.opportunity_or_project.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.opportunity_or_project.name}');
			...
			//global variable 
			sync_{/literal}{$fields.opportunity_or_project.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.opportunity_or_project.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.opportunity_or_project.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PROJECT_NAME' module='AOS_Quotes'}{/capture}
{$label|strip_semicolon}:

</div>

<div class="col-xs-12 col-sm-8 edit-view-field " type="relate" field="relate_project_name"  >
{counter name="panelFieldCount" print=false}

<input type="text" name="{$fields.relate_project_name.name}" class="sqsEnabled" tabindex="" id="{$fields.relate_project_name.name}" size="" value="{$fields.relate_project_name.value}" title='' autocomplete="off"  	 >
...
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.relate_project_name.name}" id="btn_{$fields.relate_project_name.name}" tabindex="" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"relate_project_id","name":"relate_project_name"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.relate_project_name.name}" id="btn_clr_{$fields.relate_project_name.name}" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
...
<input class="date_input" autocomplete="off" type="text" name="{$fields.expiration.name}" id="{$fields.expiration.name}" value="{$date_value}" title=''  tabindex=''    size="11" maxlength="10" >
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.expiration.name}_trigger"{/capture}
...
<input type="text" name="{$fields.billing_account.name}" class="sqsEnabled" tabindex="" id="{$fields.billing_account.name}" size="" value="{$fields.billing_account.value}" title='' autocomplete="off"  	 >
...
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.billing_account.name}" id="btn_{$fields.billing_account.name}" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_SELECT_ACCOUNTS_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_ACCESSKEY_SELECT_ACCOUNTS_LABEL"}"
onclick='open_popup(
...
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.billing_account.name}" id="btn_clr_{$fields.billing_account.name}" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE"}"  class="button lastChild"
...
<input type="text" name="{$fields.billing_contact.name}" class="sqsEnabled" tabindex="" id="{$fields.billing_contact.name}" size="" value="{$fields.billing_contact.value}" title='' autocomplete="off"  	 >
...
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.billing_contact.name}" id="btn_{$fields.billing_contact.name}" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_SELECT_CONTACTS_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_ACCESSKEY_SELECT_CONTACTS_LABEL"}"
onclick='open_popup(
...
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.billing_contact.name}" id="btn_clr_{$fields.billing_contact.name}" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_CONTACTS_TITLE"}"  class="button lastChild"
...
<td width="*">
<textarea id="billing_address_street" name="billing_address_street" maxlength="150" rows="2" cols="30" tabindex="">{$fields.billing_address_street.value}</textarea>
</td>
</tr>
<tr>
...
<td>
<input type="text" name="billing_address_city" id="billing_address_city" size="30" maxlength='150' value='{$fields.billing_address_city.value}' tabindex="">
</td>
</tr>
<tr>
...
<td>
<input type="text" name="billing_address_state" id="billing_address_state" size="30" maxlength='150' value='{$fields.billing_address_state.value}' tabindex="">
</td>
</tr>
<tr>
...
<td>
<input type="text" name="billing_address_postalcode" id="billing_address_postalcode" size="30" maxlength='150' value='{$fields.billing_address_postalcode.value}' tabindex="">
</td>
</tr>
<tr>
...
<td>
<input type="text" name="billing_address_country" id="billing_address_country" size="30" maxlength='150' value='{$fields.billing_address_country.value}' tabindex="">
</td>
</tr>
<tr>
...
<td width="*">
<textarea id="shipping_address_street" name="shipping_address_street" maxlength="150" rows="2" cols="30" tabindex="">{$fields.shipping_address_street.value}</textarea>
</td>
</tr>
<tr>
...
<td>
<input type="text" name="shipping_address_city" id="shipping_address_city" size="30" maxlength='150' value='{$fields.shipping_address_city.value}' tabindex="">
</td>
</tr>
<tr>
...
<td>
<input type="text" name="shipping_address_state" id="shipping_address_state" size="30" maxlength='150' value='{$fields.shipping_address_state.value}' tabindex="">
</td>
</tr>
<tr>
...
<td>
<input type="text" name="shipping_address_postalcode" id="shipping_address_postalcode" size="30" maxlength='150' value='{$fields.shipping_address_postalcode.value}' tabindex="">
</td>
</tr>
<tr>
...
<td>
<input type="text" name="shipping_address_country" id="shipping_address_country" size="30" maxlength='150' value='{$fields.shipping_address_country.value}' tabindex="">
</td>
</tr>
<tr>
<td scope='row' NOWRAP>
...
id='{$fields.total_amt.name}' size='30' maxlength='26,6' value='{sugar_number_format var=$value}' title='' tabindex=''
>
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_BILLING_ADDRESS_POSTALCODE' module='AOS_Quotes'}{/capture}
{$label|strip_semicolon}:

</div>

<div class="col-xs-12 col-sm-8 edit-view-field " type="varchar" field="billing_address_postalcode" colspan='3' >
{counter name="panelFieldCount" print=false}
...
id='{$fields.subtotal_amount.name}' size='30' maxlength='26,6' value='{sugar_number_format var=$value}' title='' tabindex=''
>
</div>
...
id='{$fields.shipping_amount.name}' size='30' maxlength='26,6' value='{sugar_number_format var=$value}' title='' tabindex=''
...
id='{$fields.tax_amount.name}' size='30' maxlength='26,6' value='{sugar_number_format var=$value}' title='' tabindex=''
>
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PST_TAX_AMOUNT' module='AOS_Quotes'}{/capture}
{$label|strip_semicolon}:

</div>

<div class="col-xs-12 col-sm-8 edit-view-field " type="currency" field="pst_tax_amount"  >
{counter name="panelFieldCount" print=false}

{if strlen($fields.pst_tax_amount.value) <= 0}
{assign var="value" value=$fields.pst_tax_amount.default_value }
{else}
{assign var="value" value=$fields.pst_tax_amount.value }
{/if}  
<input type='text' name='{$fields.pst_tax_amount.name}' 
id='{$fields.pst_tax_amount.name}' size='30' maxlength='26,6' value='{sugar_number_format var=$value}' title='' tabindex=''
>
</div>
...
id='{$fields.total_amount.name}' size='30' maxlength='26,6' value='{sugar_number_format var=$value}' title='' tabindex=''
>
</div>
...
addToValidate('EditView', 'pst_tax_amount', 'currency', false,'{/literal}{sugar_translate label='LBL_PST_TAX_AMOUNT' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'relate_project_id', 'id', false,'{/literal}{sugar_translate label='LBL_PROJECT_ID' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'relate_project_name', 'relate', false,'{/literal}{sugar_translate label='LBL_PROJECT_NAME' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'opportunity_or_project', 'enum', false,'{/literal}{sugar_translate label='LBL_OPPORTUNITY_OR_PROJECT' module='AOS_Quotes' for_js=true}{literal}' );
