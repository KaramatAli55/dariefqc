<?php /* Smarty version 2.6.29, created on 2017-08-13 23:18:17
         compiled from cache/themes/SuiteP/modules/AOS_Quotes/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/AOS_Quotes/DetailView.tpl', 46, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/AOS_Quotes/DetailView.tpl', 55, false),array('function', 'counter', 'cache/themes/SuiteP/modules/AOS_Quotes/DetailView.tpl', 155, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/AOS_Quotes/DetailView.tpl', 168, false),array('function', 'sugar_ajax_url', 'cache/themes/SuiteP/modules/AOS_Quotes/DetailView.tpl', 268, false),array('function', 'sugar_number_format', 'cache/themes/SuiteP/modules/AOS_Quotes/DetailView.tpl', 798, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/AOS_Quotes/DetailView.tpl', 148, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/AOS_Quotes/DetailView.tpl', 625, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/AOS_Quotes/DetailView.tpl', 625, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/AOS_Quotes/DetailView.tpl', 625, false),array('modifier', 'strip_tags', 'cache/themes/SuiteP/modules/AOS_Quotes/DetailView.tpl', 631, false),)), $this); ?>
...
"/></li>
<li><input type="button" class="button" onClick="showPopup('email');" value="<?php echo $this->_tpl_vars['MOD']['LBL_EMAIL_QUOTE']; ?>
"/></li>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="opportunity_or_project"  >

<?php if (! $this->_tpl_vars['fields']['opportunity_or_project']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['opportunity_or_project']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['opportunity_or_project']['options'][$this->_tpl_vars['fields']['opportunity_or_project']['value']]; ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="relate" field="relate_project_name"  >

<?php if (! $this->_tpl_vars['fields']['relate_project_name']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['relate_project_id']['value'] )): ?>
<?php ob_start(); ?>index.php?module=Project&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['relate_project_id']['value']; ?>
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="relate_project_id" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['relate_project_id']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['relate_project_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['relate_project_id']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
...
<div class="col-xs-12 col-sm-10 detail-view-field inlineEdit" type="currency" field="pst_tax_amount" colspan='3' >

<?php if (! $this->_tpl_vars['fields']['pst_tax_amount']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<span id='<?php echo $this->_tpl_vars['fields']['pst_tax_amount']['name']; ?>
'>
<?php echo smarty_function_sugar_number_format(array('var' => $this->_tpl_vars['fields']['pst_tax_amount']['value']), $this);?>
