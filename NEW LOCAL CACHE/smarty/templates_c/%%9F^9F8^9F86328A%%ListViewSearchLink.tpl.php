...
', '<?php if ($this->_tpl_vars['savedSearchData']['module']): ?><?php echo $this->_tpl_vars['savedSearchData']['module']; ?>
<?php else: ?><?php echo $this->_tpl_vars['pageData']['bean']['moduleName']; ?>
<?php endif; ?>');"<?php endif; ?>><?php echo $this->_tpl_vars['option']; ?>
...
">
    <li class="sugar_action_button desktopOnly">
        <a href="javascript:void(0)" class="glyphicon glyphicon-list-alt clearSearchIcon parent-dropdown-handler" onclick="SUGAR.savedViews.shortcutDropdown('_none', '<?php if ($this->_tpl_vars['savedSearchData']['module']): ?><?php echo $this->_tpl_vars['savedSearchData']['module']; ?>
<?php else: ?><?php echo $this->_tpl_vars['pageData']['bean']['moduleName']; ?>
<?php endif; ?>');"></a>
        <a href="javascript:void(0)" class="glyphicon glyphicon-remove" onclick="SUGAR.savedViews.shortcutDropdown('_none', '<?php if ($this->_tpl_vars['savedSearchData']['module']): ?><?php echo $this->_tpl_vars['savedSearchData']['module']; ?>
<?php else: ?><?php echo $this->_tpl_vars['pageData']['bean']['moduleName']; ?>
<?php endif; ?>');">&Cross;</a>
    </li>
