<?php /* Smarty version 2.6.29, created on 2017-07-31 11:49:35
         compiled from cache/themes/SuiteP/modules/Project/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/Project/SearchForm_advanced.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/Project/SearchForm_advanced.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Project/SearchForm_advanced.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Project/SearchForm_advanced.tpl', 77, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/Project/SearchForm_advanced.tpl', 84, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Project/SearchForm_advanced.tpl', 534, false),array('modifier', 'default', 'cache/themes/SuiteP/modules/Project/SearchForm_advanced.tpl', 92, false),)), $this); ?>
...
<?php if (isset ( $_REQUEST['estimated_start_date_advanced_range_choice'] )): ?>
<?php $this->assign('starting_choice', $_REQUEST['estimated_start_date_advanced_range_choice']); ?>
<?php else: ?>
...
" value='<?php if (empty ( $_REQUEST['range_estimated_start_date_advanced'] ) && ! empty ( $_REQUEST['estimated_start_date_advanced'] )): ?><?php echo $_REQUEST['estimated_start_date_advanced']; ?>
<?php else: ?><?php echo $_REQUEST['range_estimated_start_date_advanced']; ?>
...
<?php if (isset ( $_REQUEST['estimated_end_date_advanced_range_choice'] )): ?>
<?php $this->assign('starting_choice', $_REQUEST['estimated_end_date_advanced_range_choice']); ?>
<?php else: ?>
<?php $this->assign('starting_choice', "="); ?>
<?php endif; ?>
...
<input autocomplete="off" type="text" name="range_<?php echo $this->_tpl_vars['id']; ?>
" id="range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php if (empty ( $_REQUEST['range_estimated_end_date_advanced'] ) && ! empty ( $_REQUEST['estimated_end_date_advanced'] )): ?><?php echo $_REQUEST['estimated_end_date_advanced']; ?>
<?php else: ?><?php echo $_REQUEST['range_estimated_end_date_advanced']; ?>
<?php endif; ?>' title=''   size="11" class="dateRangeInput">
<?php ob_start(); ?>alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['id']; ?>
_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean(); ?>
