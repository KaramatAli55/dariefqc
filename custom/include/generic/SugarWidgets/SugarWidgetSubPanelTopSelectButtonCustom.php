...
class SugarWidgetSubPanelTopSelectButtonCustom extends SugarWidgetSubPanelTopSelectButton
{
     ...
     */
    function SugarWidgetSubPanelTopSelectButtonCustom($button_properties = array())
    {
    ...
    function display($widget_data, $additionalFormFields = NULL, $nonbutton = false)
    {
        ...
        $GLOBALS['log']->fatal('$return_module :::: ' .$return_module);
        $GLOBALS['log']->fatal('$subpanel_name :::: ' .$subpanel_name);
        if ($return_module == 'Project' && $subpanel_name == 'sub_projects') {
            $initial_filter .= "&project_id=" . $return_id;
        }
        else if($return_module == 'ProjectTask' && $subpanel_name == 'sub_projecttasks'){
            $initial_filter .= "&projecttask_id=" . $return_id;
        }
        $GLOBALS['log']->fatal('$initial_filter :::: ' .$initial_filter);
